        ...
        <div className="card-deck" style={{ margin: '30px' }}>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                “Once you’ve mastered the basic porridge recipe, get creative
                and add your favourite toppings. Think fruit, toasted nuts and
                honey
              </p>
              <p className="card-text">
                <small className="text-muted">Last updated 3 mins ago</small>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                “It never fails to blow my mind how a simple marinade, like this
                rosemary one, can elevate humble ingredients to such a beautiful
                place.
              </p>
              <p className="card-text">
                <small className="text-muted">Last updated 3 mins ago</small>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                “If you like salmon, you’ll love this quick and easy recipe –
                think flaky, juicy flesh kissed with gentle spice and the
                crispiest skin ever, buddied up with my fail-safe, fluffy
                coconut rice and refreshing cucumber pickle. Get in! ”
              </p>
              <p className="card-text">
                <small className="text-muted">Last updated 3 mins ago</small>
              </p>
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                “I’m told that in the UK avocados are now more popular than
                oranges! This breakfast favourite is a source of vitamin E,
                which acts as an antioxidant, helping to protect our cells. ”
              </p>
              <p className="card-text">
                <small className="text-muted">Last updated 3 mins ago</small>
              </p>
